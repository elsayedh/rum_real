...

{
    ...
    "description": """
      ...
      odoo multiple branch enterprise accounting reports multiple branch with accounting reports odoo multiple branch enterprise accounting reports
	    odoo multi branch accounting reports multibranch accounting reports
      odoo multibranch accounting enterprise reports multi branch enterprise accounting reports multi branch with accounting reports
      odoo multi branch enterprise accounting reports multiple unit accounting reports
      odoo multiple unit accounting enterprise reports multiple unit enterprise accounting reports odoo multiple unit with accounting reports
      odoo multiple unit enterprise accounting reports multiple unit operation accounting reports
      odoo multiple unit operation enterprise reports multiple unit operation enterprise accounting reports
      odoo multiple unit operation with accounting reports multiple unit operation enterprise accounting reports
